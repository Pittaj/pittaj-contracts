...
* **auth:** verify-credentials autoriza una acción y devuelve un vale ([5ae87ea](https://github.com/Pittaj/pittaj-contracts/commit/5ae87ea1032c63ffeaa8d56b0fb24386467c31c2))
...
* **business-line:** línea de negocio como dimensión del tenant — 1.16.0 ([deb4224](https://github.com/Pittaj/pittaj-contracts/commit/deb422466064e7ea188d033c090f494b977d37d1))
...
* **checkout:** la tabla de autorización de la Caja, escrita una vez ([758ce77](https://github.com/Pittaj/pittaj-contracts/commit/758ce77a1de8de72cd3d8ab3705d555b316cc2f0))
...
* initial contracts package - schemas, DTOs, responses, primitives ([6ad8952](https://github.com/Pittaj/pittaj-contracts/commit/6ad8952258a3aa6d71c1917e6dfaf2c0e6c1213d))
...
* **inventory:** traspasos como documento + reposición dice con qué se resuelve ([fad7492](https://github.com/Pittaj/pittaj-contracts/commit/fad7492c91018f2c23b49e4c4cf3f3ef70b01c3f))
...
* **layaway:** el nombre del cliente viaja en snapshot (customerName) ([9348e78](https://github.com/Pittaj/pittaj-contracts/commit/9348e7846fe8364986a147aacecfbb50952a5b4e))
...
* **pos-session:** la caja registradora del turno viaja en el contrato ([6a0bb8d](https://github.com/Pittaj/pittaj-contracts/commit/6a0bb8d62613617637cea605e0ed7d9deba570b8))
...
* **product:** contratos de «Fusionar con…» (1.10.0) ([83d222b](https://github.com/Pittaj/pittaj-contracts/commit/83d222bf9707412b2a5352c69d963bf7da6101a3))
...
* **product:** la marca de fusión viaja en el sync (1.11.0) ([a1b56be](https://github.com/Pittaj/pittaj-contracts/commit/a1b56be77d4db4639e3bfbf759b26cab5d4bd395))
...
* **purchase:** «Corregir producto» y quitar comprobante — 1.9.0 ([dbb9bca](https://github.com/Pittaj/pittaj-contracts/commit/dbb9bcadd0d20ba682f8562f9a3c4510640720aa))
...
* **purchase:** contrato para atender una solicitud con una compra existente ([99072ce](https://github.com/Pittaj/pittaj-contracts/commit/99072ce227f5f383f08a03333c9015934c225bcf))
...
* **purchase:** el emparejado aprende hacia adelante — alias por producto, código de barras, sugerencias con porcentaje ([300b9e6](https://github.com/Pittaj/pittaj-contracts/commit/300b9e6bf1e99de8ef801f7debe1c055a88b7d9c))
* **purchase:** Importar CFDI desde la lista — clasificación del archivo, enlazar con ajuste por redondeo — 1.8.0 ([79e8da5](https://github.com/Pittaj/pittaj-contracts/commit/79e8da585e18bd8b42ffe095afbf45475f070f5a))
* **purchase:** la solicitud puede nacer en borrador; editar, enviar y GET por id ([345c74a](https://github.com/Pittaj/pittaj-contracts/commit/345c74a81a5cf75eb0a8b717d14594ae27e468ca))
* **purchase:** marca de procedencia del renglón (origin/originDetail/originUser/originAt) — 1.7.0 ([87e7f77](https://github.com/Pittaj/pittaj-contracts/commit/87e7f772984615f1f909afda85e02a3b71132f80))
...
* **purchase:** PurchaseResponse.cfdiAdjustments (anidados como las recepciones) — 1.8.1 ([0461a40](https://github.com/Pittaj/pittaj-contracts/commit/0461a40baec43b6c91633627e0ed7974c86c5354))
...
* **purchase:** userName en correctPurchaseLineSchema — 1.9.1 ([f727a3d](https://github.com/Pittaj/pittaj-contracts/commit/f727a3d9d3b82cc751c0bbbc09c4ccf30dfe5885))
* reabrir una compra, su vista previa y el total de lo filtrado ([9f0d202](https://github.com/Pittaj/pittaj-contracts/commit/9f0d202a79220cd343c3e45badd76dfeaba28af9))
* **received-cfdi:** avisos con datos del comprobante/emisor y «reclamar al proveedor» ([cb08230](https://github.com/Pittaj/pittaj-contracts/commit/cb0823004e7a741a52514f3966c21920c918098d))
...
* remove hono types from contracts (moved to backend) ([307424c](https://github.com/Pittaj/pittaj-contracts/commit/307424c568f46cde048c46c39a88179447b2776a))
...
* **sat-download:** planificador de días abiertos y contratos de la e.firma resguardada — 1.15.0 ([2b2c102](https://github.com/Pittaj/pittaj-contracts/commit/2b2c1021dcecefa15fc9fb0739767a83939d640e))
...
* **shared:** letra T para los folios de traspaso (TW- en la web, TS1- en la caja) ([4dacb07](https://github.com/Pittaj/pittaj-contracts/commit/4dacb079ed8953ba2a61ef5762fd3800f8a343f9))
...
* **subscription-summary:** alta de la tarjeta del cobro por operaciones (startCardSubscriptionSchema) ([76756d5](https://github.com/Pittaj/pittaj-contracts/commit/76756d57d0cd29b83f9c63e45efc7af67bdbe2c7))
* **subscription-summary:** campos del cobro por operaciones en AvailablePlan (1.13.0) ([3641ed0](https://github.com/Pittaj/pittaj-contracts/commit/3641ed0cc382a91e9ae05fa45d69325648260da9))
* **subscription-summary:** campos del cobro por operaciones en AvailablePlan (1.13.0) ([0e4f526](https://github.com/Pittaj/pittaj-contracts/commit/0e4f5262ff23ba93696b20e65a4f5c8e3a04fc7f))
* **subscription-summary:** CardSubscriptionInfoResponse ([68dfe3f](https://github.com/Pittaj/pittaj-contracts/commit/68dfe3f0cf5a116675911f79a1e1a2b9f61758a2))
...
* **suite:** «Líneas de negocio» en el catálogo de Organización ([a32fc5e](https://github.com/Pittaj/pittaj-contracts/commit/a32fc5ec7799e0e625e90a761a7dca502dc76bdc))
* **suite:** Apartados es módulo de Trastienda (tpv/apartados) ([fdfe6e7](https://github.com/Pittaj/pittaj-contracts/commit/fdfe6e7304a5537b4252b50cf42dcd54f4fa95ed))
* **suite:** catálogo único de apps y módulos, y contrato de visibilidad ([886a970](https://github.com/Pittaj/pittaj-contracts/commit/886a970202f1479653e181ab03b378bd66197c1c))
* **suite:** Organización no se puede apagar ([1cc0550](https://github.com/Pittaj/pittaj-contracts/commit/1cc055039336a29308eac9ff2565a3ad79243403))
...
* **supplier:** contratos de «Fusionar con…» para proveedores (1.12.0) ([09f63c9](https://github.com/Pittaj/pittaj-contracts/commit/09f63c9312b59696a455d27401e8875aa7cc682c))
...
* **supplier:** el código es opcional al crear — la nube asigna PROV-NNNNN como el escritorio ([4d9245b](https://github.com/Pittaj/pittaj-contracts/commit/4d9245b6ddfeda94dac9dbce6d5dc724adcbc337))
...
* **usage-limit:** buscar por folio en la lista de operaciones (1.14.0) ([434dca0](https://github.com/Pittaj/pittaj-contracts/commit/434dca0233efe04cc3de3c4eaa86a040ccd812ad))
* **usage-limit:** buscar por folio en la lista de operaciones (1.14.0) ([3918559](https://github.com/Pittaj/pittaj-contracts/commit/391855989ea84db90353c00cc5bb04b5783c534f))
* **usage-limit:** contratos de operaciones contadas (1.11.0) ([9fe495e](https://github.com/Pittaj/pittaj-contracts/commit/9fe495ec36aa7ef07635e7135cd5b2de1b92947c))
* **usage-limit:** contratos de operaciones contadas (1.11.0) ([53b4d50](https://github.com/Pittaj/pittaj-contracts/commit/53b4d50dc5ea52d45e26cf36750fba596ea7611e))
...
* bump version ([a8e6c9b](https://github.com/Pittaj/pittaj-contracts/commit/a8e6c9b2054f57ccb1f4c7d199f1a88c6524da61))
...
* **subscription-summary:** exportar CardSubscriptionResponse ([61f1d93](https://github.com/Pittaj/pittaj-contracts/commit/61f1d93a0ab7c6ed5adc7312353659163d3441e2))
* **suite:** Operaciones del mes en el catálogo de Organización ([78d3dea](https://github.com/Pittaj/pittaj-contracts/commit/78d3dea01432f1e2d19f620665fb97c64b3f6e6d))
* **suite:** Productos y Categorías de Compras en el catálogo ([ac4aa64](https://github.com/Pittaj/pittaj-contracts/commit/ac4aa642fedfa0a18bfc42032b51efd10c5e6c5e))
* **suite:** Productos y Categorías de Compras en el catálogo ([34faae2](https://github.com/Pittaj/pittaj-contracts/commit/34faae2646f317d24f70dc2ac556321e6b89c36a))
...
* trailing comma in package.json exports ([3ddfb12](https://github.com/Pittaj/pittaj-contracts/commit/3ddfb120c4c42d7a87f33099079957797d240737))
