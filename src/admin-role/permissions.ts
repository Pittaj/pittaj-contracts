...
export const ADMIN_PERMISSIONS: readonly AdminPermissionDef[] = [
    ...
    { group: 'Facturas', key: 'invoices.view', label: 'Ver facturas' },
    { group: 'Facturas', key: 'invoices.manage', label: 'Generar, emitir y cancelar facturas' },
    { group: 'Pagos', key: 'payments.view', label: 'Ver pagos' },
    { group: 'Pagos', key: 'payments.manage', label: 'Registrar y reembolsar pagos' },
    ...
    { group: 'Soporte', key: 'support.view', label: 'Ver tickets de soporte' },
    { group: 'Soporte', key: 'support.manage', label: 'Atender tickets de soporte' },
